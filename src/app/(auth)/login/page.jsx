...
const SignInPage = () => {
    ...
    return (
        <div className=" min-w-7xl mx-auto border-green-400  overflow-hidden mt-20">
            <div className="text-center">
                <h2 className="text-2xl font-bold my-3">Welcome Back</h2>
                <p>Resume your adventure with Health-Care</p>
            </div>
            ...
            <div className="py-3 flex justify-center items-center gap-3">Dont't have an account? <Link className="text-blue-500" href={'signup'}>Create an Account</Link></div>
        </div>
    );
};
